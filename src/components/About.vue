<template>
    <div id="about"
        class="about-section bg-[url('@/assets/img/aboutPattern.svg')] bg-no-repeat bg-cover bg-center w-screen overflow-x-hidden md:h-[100vh] h-fit flex flex-col-reverse md:flex-row sm:bg-right md:bg-right  xl:bg-center">
